...
enable_action_mine(action_input);

enable_action_attack(action_input);

//enable_action_smash(jump_height, right_input, left_input, jump_input, jump_release_input);