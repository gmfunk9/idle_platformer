...
/// @param {int}    base_width      The base width for the game room
/// @param {int}    base_height     The base height for the game room
/// @param {int}    current_width   The current width of the game canvas
/// @param {int}    current_height  The current height of the game canvas
